...
const socialLinks = [
  {
    label: "GitHub",
    href: "https://github.com/sridharjd",
    icon: <GithubIcon />,
    hoverClass: "hover:bg-[#24292e] hover:text-white hover:border-[#24292e]",
  },
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/sridharjd",
    icon: <LinkedInIcon />,
    hoverClass: "hover:bg-[#0077B5] hover:text-white hover:border-[#0077B5]",
  },
  {
    label: "Instagram",
    href: "https://instagram.com/_sridharduraisamy",
    icon: <InstagramIcon />,
    hoverClass: "hover:bg-[#E1306C] hover:text-white hover:border-[#E1306C]",
  },
  {
    label: "WhatsApp",
    href: "https://wa.me/917639524474",
    icon: <WhatsAppIcon />,
          ...
          <div className="google-elevated p-10 md:p-16 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-4 mb-10">
                <a href="mailto:sridharpharmkv@gmail.com" className="btn-google inline-flex items-center gap-2">
                  <Mail size={16} />
                  Send an email
                  <ArrowUpRight size={14} />
                </a>
                <a href="tel:+917639524474" className="btn-google-outline inline-flex items-center gap-2">
                  <Phone size={16} />
                  Call me
                </a>
              </div>
        ...
        <RevealOnScroll>
          <div className="text-center mt-10">
            <p className="text-xs text-muted-foreground">
              © 2026 Sridhar JD. All rights reserved.
            </p>
          </div>
        </RevealOnScroll>
      </div>
